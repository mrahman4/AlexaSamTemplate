...
4. Give your new skill a **Name** , for example ** miriams journey ** or ** Play with Miriam** This is the name that will be shown in the Alexa Skills Store, and the name your users will refer to. Also change the locale if so desired. Push Next.
