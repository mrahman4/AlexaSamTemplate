...
At this point, you should have a working copy of our Alexa-Nodejs-Dynamic-Content skill.  In order to make it your own, you will need to customize it with data and responses that you create.  Here are the things you will need to change:
